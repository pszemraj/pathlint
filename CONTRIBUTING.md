...
Welcome to `pathlint` contributor's guide.
...
If you experience bugs or general issues with `pathlint`, please have a look
...
You can help improve `pathlint` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pathlint` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pathlint`'s files. While this mechanism can
...
```
conda create -n pathlint python=3 six virtualenv pytest pytest-cov
conda activate pathlint
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pathlint.git
   cd pathlint
   ```
...
5. Install [pre-commit]:
   ...
   `pathlint` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pathlint
[issue tracker]: https://github.com/<USERNAME>/pathlint/issues
